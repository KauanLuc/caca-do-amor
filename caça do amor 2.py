...
while data != data1:
    data = float(input('Digite a data mais importante do universo para continuar e, poder ganhar {}recompensas incríveis{}: '.format('\33[31m' , '\33[m')))
    if data == data1:
        break
print()
...
while resposta4 != enigma4:
    resposta4 = str(input('Digite sua resposta aqui: '))
